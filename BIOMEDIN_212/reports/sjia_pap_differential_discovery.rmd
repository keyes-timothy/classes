...
And from these results, we can see that neutrophils, T-cells, and Macrophages tend to have differentially expressed markers (whereas other cell populations don't). 
...
As noted above, we can see that T-cells and Neutrophils have the significant marker differences. 
...
In this analysis, we see that CD16+ cells, B-cells, monocytes, T-regs, and the lung endothelium and epithelium themselves differe in the expression of several markers. 

`r pagebreak()`

# Spatial Analysis

Within FOVs, we can also annotate individual cells depending on whether they overlap with surfactant/lipid plaques and use these annotations to 
